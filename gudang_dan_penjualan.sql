...
CREATE TABLE `produk` (
  `id_produk` int(11) NOT NULL COMMENT 'ID unik untuk setiap produk',
  `nama_produk` varchar(100) NOT NULL COMMENT 'Nama produk',
  `harga_beli` decimal(10,2) NOT NULL COMMENT 'Harga beli produk (dalam mata uang lokal)',
  `harga_jual` decimal(10,2) NOT NULL COMMENT 'Harga jual produk (dalam mata uang lokal)',
  `satuan` varchar(20) NOT NULL COMMENT 'Satuan produk (misal: pcs, kg, liter)',
  `deskripsi` text DEFAULT NULL COMMENT 'Deskripsi atau keterangan tambahan tentang produk'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Tabel untuk menyimpan informasi produk';
...
--
ALTER TABLE `produk`
  MODIFY `id_produk` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID unik untuk setiap produk';
